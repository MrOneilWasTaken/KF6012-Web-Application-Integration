<?php 
/**
 * Documentation HTML page controller
 * 
 * Constructs the documentation HTML webpage   
 *  
 ...
 */
    class DocumentationController extends Controller
    {
        protected function processRequest(){
            ...
            $page->addLink("http://unn-w18018623.newnumyspace.co.uk/kf6012/coursework/part1/","Link to Home Page");
